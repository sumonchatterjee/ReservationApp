...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	public interface OnCustomiseTabViewListener {
		...
		void onCustomiseTab(int position, View tabView,
							boolean isCurrentTab);
	}

	private OnCustomiseTabViewListener onCustomiseTabViewListener;

	public OnCustomiseTabViewListener getOnCustomiseTabViewListener() {
		return onCustomiseTabViewListener;
	}

	public void setOnCustomiseTabViewListener(
			OnCustomiseTabViewListener onCustomiseTabViewListener) {
		this.onCustomiseTabViewListener = onCustomiseTabViewListener;
	}
	...
	private void populateTabStrip() {
		...
		for (int i = 0; i < adapter.getCount(); i++) {
			...
			if (onCustomiseTabViewListener != null) {
				onCustomiseTabViewListener.onCustomiseTab(i, tabView,
		...
		public void onClick(View view) {
			for (int i = 0; i < mTabStrip.getChildCount(); i++) {
				if (view == mTabStrip.getChildAt(i)) {
					mViewPager.setCurrentItem(i, isSmoothScroll);
					return;
				}
			}
		}
	...
	public void setIndicatorScrollAnimation(boolean smoothScroll) {
