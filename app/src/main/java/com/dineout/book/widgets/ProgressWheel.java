...
public class ProgressWheel extends View {
    ...
    private void setupPaints() {
        ...
        barPaint.setStrokeWidth(barWidthWheel);
    ...
    private void setupBounds(int layout_width, int layout_height) {
        ...
        if (!fillRadius) {
            ...
            int circleDiameter = Math.min(minValue, circleRadius * 2 - barWidthWheel * 2);

            // Calc the Offset if needed for centering the wheel in the available space
            int xOffset = (layout_width - paddingLeft - paddingRight - circleDiameter) / 2 + paddingLeft;
            int yOffset = (layout_height - paddingTop - paddingBottom - circleDiameter) / 2 + paddingTop;

            circleBounds = new RectF(xOffset + barWidthWheel,
                    yOffset + barWidthWheel,
                    xOffset + circleDiameter - barWidthWheel,
                    yOffset + circleDiameter - barWidthWheel);
        } else {
            circleBounds = new RectF(paddingLeft + barWidthWheel,
                    paddingTop + barWidthWheel,
                    layout_width - paddingRight - barWidthWheel,
                    layout_height - paddingBottom - barWidthWheel);
        }
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        barWidthWheel = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, barWidthWheel, metrics);
...
//
//        barWidthWheel = (int) a.getDimension(R.styleable.ProgressWheel_barWidth, barWidthWheel);
//
...
//        }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        ss.barWidth = this.barWidthWheel;
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        this.barWidthWheel = ss.barWidth;
     ...
     */
    public int getBarWidthWheel() {
        return barWidthWheel;
    }

    /**
     * Sets the width of the spinning bar
     *
     * @param barWidthWheel the spinning bar width in pixels
     */
    public void setBarWidthWheel(int barWidthWheel) {
        this.barWidthWheel = barWidthWheel;
        if (!isSpinning) {
            invalidate();
        }
    }
